...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'megakit-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'megakit-core' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'megakit-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'megakit-core' ),
			]
		);
